...
# ================== APP SETUP & INITIALIZATION (ĐÃ SỬA LỖI) ==================
# Bước 1: Khởi tạo Flask App MỘT LẦN DUY NHẤT.
app = Flask(__name__, template_folder="../frontend/templates")
app.secret_key = os.urandom(24)

# Bước 2: Nhập và đăng ký Blueprint cho hardware_api.
# Dòng này "dạy" cho app biết về các route trong file hardware_api.py.
from hardware_api import hardware_bp
app.register_blueprint(hardware_bp)

# Bước 3: Khởi tạo SocketIO sau khi app đã được cấu hình.
